  ...
  it("should generate all practical examples in a single workbook", async () => {
    ...
    workbook.addSheet({
      ...
      headers: [
        ...
        {
          key: "joinDate",
          label: { value: "入社日", style: { font: { bold: true } } },
          width: 12,
          format: "yyyy/mm/dd",
        },
    ...
    workbook.addSheet({
      ...
      rows: [
        ...
        { no: "", item: "", spec: "", quantity: "", unit: "", unitPrice: "", amount: "" },
        {
          ...
          spec: "",
          quantity: "",
          unit: { value: "小計", style: { font: { bold: true }, alignment: { horizontal: "right" } } },
          unitPrice: "",
          amount: { value: 3400000, style: { font: { bold: true } } },
        },
        {
          no: "",
          item: "",
          spec: "",
          quantity: "",
          unit: { value: "消費税(10%)", style: { alignment: { horizontal: "right" } } },
          unitPrice: "",
          amount: 340000,
        },
        {
          ...
          spec: "",
          quantity: "",
          unit: { value: "合計", style: { font: { bold: true, size: 14 }, alignment: { horizontal: "right" } } },
          unitPrice: "",
          amount: { value: 3740000, style: { font: { bold: true, size: 14 }, fill: { color: "#FFFF00" } } },
        },
      ],
      styles: {
        header: {
